...
def estimate_sem_data(data):
    ...
    model = ModelFactory(input_length, tr_sem_data.shape[1], output_length)(ModelType.STRAIGHT_AE)
    model.fit(train_data, data['train_labels'], test_data, data['test_labels'], 50, '.', save_weights=False, run_svm=False)
