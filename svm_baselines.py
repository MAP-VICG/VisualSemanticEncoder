...
result['i_cub']['sec'] = svm_cub.classify_sec_data(vis_data, sem_data, lbs_data, n_folds, n_epochs, True, 'results/i_cub')
...
result['r_cub']['sec'] = svm_cub.classify_sec_data(vis_data, sem_data, lbs_data, n_folds, n_epochs, True, 'results/r_cub')
...
result['i_awa']['sec'] = svm_awa.classify_sec_data(vis_data, sem_data, lbs_data, n_folds, n_epochs, True, 'results/i_awa')
...
result['r_awa']['sec'] = svm_awa.classify_sec_data(vis_data, sem_data, lbs_data, n_folds, n_epochs, True, 'results/r_awa')

with open('baseline_result_sec.json', 'w+') as f:
