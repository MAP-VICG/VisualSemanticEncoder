...
# plt.xlabel('Atributos Semânticos', fontsize=18)
...
tree = ET.parse('/Users/damaresresende/Desktop/results/ae_results_ind_simple.xml')
root = tree.getroot()
   
ref = [float(root.find('REF/accuracy/f1-score').text)] * 50
...
plt.legend(['referência', 'todos', 'partes', 'textura', 'cor', 'forma'], loc='bottom right', fontsize=7)
...
plt.legend(['referência', 'todos', 'sem partes', 'sem textura', 'sem cor', 'sem forma'], loc='bottom right', fontsize=7)
                
plt.savefig('/Users/damaresresende/Desktop/ae_results_ind_simple.png', bbox_inches='tight')
