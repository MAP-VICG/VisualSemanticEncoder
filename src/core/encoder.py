...
class SemanticEncoder:
    ...
    def run_encoder(self, tag, **kwargs):
        ...
        ae = Autoencoder(cv=5, njobs=-1, x_train=x_train, x_test=x_test, y_train=y_train, y_test=y_test)
    ...
    @staticmethod
    def remove_random(features, start, end, noise_level, seed=None):
        """
