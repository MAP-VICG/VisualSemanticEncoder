...
from autoencoder.src.autoencoder import ModelFactory, ModelType, Autoencoder
...
class ModelFactoryTests(unittest.TestCase):
    ...
    def test_fit(self):
        ...
        self.assertEqual(['loss', 'val_loss', 'acc', 'best_accuracy', 'best_model_weights'], ae.history.keys())
