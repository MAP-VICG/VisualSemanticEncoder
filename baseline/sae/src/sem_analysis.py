...
class SemanticDegradation:
    def __init__(self, datafile, n_folds, new_value, data_type, verbose=False):
        ...
        self.acc['new_value'] = self.new_value
    ...
    def degrade_semantic_data(self):
        ...
        for rate in self.rates:
            for j in range(self.n_folds):
                ...
                self.data.set_semantic_data(self.kill_semantic_attributes(self.data.data['S_tr'], rate, self.new_value))
...
if __name__ == '__main__':
    ...
    for key_value in [0, 0.001, 0.1, -1, 9999]:
